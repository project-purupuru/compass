---
name: "source-command-audit-deployment"
description: "Security audit of deployment infrastructure.
Reviews server setup, configs, hardening, secrets management."
---

# source-command-audit-deployment

Use this skill when the user asks to run the migrated source command `audit-deployment`.
