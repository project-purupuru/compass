---
name: "source-command-plan-and-analyze"
description: "Launch PRD discovery with automatic codebase grounding and context ingestion.
...
# source-command-plan-and-analyze

Use this skill when the user asks to run the migrated source command `plan-and-analyze`.
